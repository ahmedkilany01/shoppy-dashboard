  ...
  return (
    <div className="mt-24">
      <div className="flex justify-center flex-wrap lg:flex-nowrap">
        <div className="bg-white dark:bg-secondary-dark-bg dark:text-gray-200 h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-center bg-no-repeat bg-cover">
          <div className="flex justify-between items-center">
            ...
            <button
              type="button"
              className="rounded-full text-2xl p-4 text-white hover:drop-shadow-xl"
      ...
      <div className="flex flex-wrap justify-center gap-10">
        <div className="bg-white dark:bg-secondary-dark-bg dark:text-gray-200 rounded-2xl m-3 p-4 md:w-780">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-10">
            <div className="border-r-1 m-4 p-10">
              <div>
                <p>
                  <span className="text-3xl font-semibold">$93,438</span>
                  <span className="p-1.5 cursor-pointer rounded-full hover:drop-shadow-xl bg-green-400 ml-3 text-xs text-white">
                    23%
                  </span>
                </p>
              ...
              <div className="mt-8">
                <p>
                  <span className="text-3xl font-semibold">$50,487</span>
                </p>
        ...
        <div className="flex gap-10 m-4 flex-wrap justify-center">
          <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg p-6 rounded-2xl">
            <div className="flex justify-between items-center gap-2">
              ...
              <dropdownData currentMode={currentMode} />
            </div>
